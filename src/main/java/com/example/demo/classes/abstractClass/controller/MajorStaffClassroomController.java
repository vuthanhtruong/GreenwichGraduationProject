...
@Controller
@RequestMapping("/staff-home/specialized-classes-list/classroom")
public class MajorStaffClassroomController {
    ...
    public MajorStaffClassroomController(ClassesService classesService, MajorClassPostsService majorClassPostsService,
    ...
    public String showClassroomGet(HttpSession session, Model model) {
        try {
            ...
            if (classes instanceof MajorClasses majorClasses) {
                ...
                model.addAttribute("classes", classes);
                model.addAttribute("ClassPostsList", classPostsList);
                model.addAttribute("listClass", "/staff-home/specialized-classes-list");
                model.addAttribute("home", "/staff-home");
                model.addAttribute("addPostClass", "/staff-home/specialized-classes-list");
                model.addAttribute("addAsm", "/staff-home");
    ...
    public String showClassroomPost(@RequestParam("classId") String classId, HttpSession session, Model model) {
        try {
            ...
            if (classes instanceof MajorClasses majorClasses) {
                ...
                model.addAttribute("listClass", "/staff-home/classes-list");
                model.addAttribute("home", "/staff-home");
                model.addAttribute("addPostClass", "/staff-home/specialized-classes-list/classroom/upload-major-post");
                model.addAttribute("addAsm", "/staff-home/specialized-classes-list/classroom/create-major-assignment-slot");
                return "MajorLecturerClassroom";
            } else if (classes instanceof SpecializedClasses specializedClasses) {
                List<SpecializedClassPosts> specializedClassPosts = specializedClassPostsService.getClassPostsByClass(classId);
                List<SpecializedAssignmentSubmitSlots> assignmentSubmitSlots = specializedAssignmentSubmitSlotsService.getAllSpecializedAssignmentSubmitSlotsByClass(specializedClasses);
                ...
                model.addAttribute("listClass", "/staff-home/specialized-classes-list");
                model.addAttribute("home", "/staff-home");
                model.addAttribute("addPostClass", "/staff-home/specialized-classes-list/classroom/upload-specialized-post");
                model.addAttribute("addAsm", "/staff-home/specialized-classes-list/classroom/create-specialized-assignment-slot");
                return "SpecializedLecturerClassroom";
            }
