...
public class ThymeleafConfig {
    ...
    public SpringResourceTemplateResolver templateResolver21() {
        SpringResourceTemplateResolver resolver = new SpringResourceTemplateResolver();
        resolver.setPrefix("classpath:/templates/EmailTemplate/");
        resolver.setSuffix(".html");
        resolver.setTemplateMode("HTML");
    ...
    @Bean
    public SpringResourceTemplateResolver templateResolver29() {
        SpringResourceTemplateResolver resolver = new SpringResourceTemplateResolver();
        resolver.setPrefix("classpath:/templates/SupportTicketsList/");
        resolver.setSuffix(".html");
        resolver.setTemplateMode("HTML");
        resolver.setOrder(29);
        resolver.setCheckExistence(true);
        return resolver;
    }
    @Bean
    public SpringResourceTemplateResolver templateResolver30() {
        SpringResourceTemplateResolver resolver = new SpringResourceTemplateResolver();
        resolver.setPrefix("classpath:/templates/MinorLecturer/");
        resolver.setSuffix(".html");
        resolver.setTemplateMode("HTML");
    ...
    @Bean
    public SpringResourceTemplateResolver templateResolver31() {
        SpringResourceTemplateResolver resolver = new SpringResourceTemplateResolver();
        resolver.setPrefix("classpath:/templates/MinorSubject/");
        resolver.setSuffix(".html");
        resolver.setTemplateMode("HTML");
        resolver.setOrder(31);
        resolver.setCheckExistence(true);
        return resolver;
    }
    @Bean
    public SpringResourceTemplateResolver templateResolver32() {
        SpringResourceTemplateResolver resolver = new SpringResourceTemplateResolver();
        resolver.setPrefix("classpath:/templates/Messages/");
        resolver.setSuffix(".html");
        resolver.setTemplateMode("HTML");
        resolver.setOrder(32);
        resolver.setCheckExistence(true);
        return resolver;
    }
    @Bean
    ...
    @Bean
    public SpringResourceTemplateResolver templateResolver34() {
        SpringResourceTemplateResolver resolver = new SpringResourceTemplateResolver();
        resolver.setPrefix("classpath:/templates/Notification/");
        resolver.setSuffix(".html");
        resolver.setTemplateMode("HTML");
        resolver.setOrder(34);
        resolver.setCheckExistence(true);
        return resolver;
    }
    @Bean
    public SpringResourceTemplateResolver templateResolver35() {
        SpringResourceTemplateResolver resolver = new SpringResourceTemplateResolver();
        resolver.setPrefix("classpath:/templates/Attendance/");
        resolver.setSuffix(".html");
        resolver.setTemplateMode("HTML");
        resolver.setOrder(35);
        resolver.setCheckExistence(true);
        return resolver;
    }
    @Bean
    ...
    @Bean
    public SpringResourceTemplateResolver templateResolver37() {
        SpringResourceTemplateResolver resolver = new SpringResourceTemplateResolver();
        resolver.setPrefix("classpath:/templates/Dashboard/");
        resolver.setSuffix(".html");
        resolver.setTemplateMode("HTML");
        resolver.setOrder(37);
        resolver.setCheckExistence(true);
        return resolver;
    }
    @Bean
    public SpringResourceTemplateResolver templateResolver38() {
        SpringResourceTemplateResolver resolver = new SpringResourceTemplateResolver();
        resolver.setPrefix("classpath:/templates/ParentAccount/");
        resolver.setSuffix(".html");
        resolver.setTemplateMode("HTML");
        resolver.setOrder(38);
        resolver.setCheckExistence(true);
        return resolver;
    }
}
