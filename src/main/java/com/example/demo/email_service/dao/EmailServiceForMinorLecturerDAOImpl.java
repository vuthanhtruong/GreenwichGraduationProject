...
@Repository
@Slf4j
public class EmailServiceForMinorLecturerDAOImpl implements EmailServiceForMinorLecturerDAO {
    ...
    private String generateEmailTemplate(
        ...
        // Info table - Có thêm Employment Type
        html.append("<table class='info-table' role='presentation' width='100%' cellpadding='0' cellspacing='0' style='border:1px solid #e5e7eb;border-radius:10px;overflow:hidden;'>")
                ...
                .append("</tr>")
                .append("<tr style='background:#f8fafc;'>")
                .append("<td style='padding:12px 14px;font-size:14px;color:#1f2937;font-weight:600;border-bottom:1px solid #e5e7eb;font-family:sans-serif;'>Employment Type</td>")
    ...
    public void sendEmailToNotifyLoginInformation(String to, String subject, MinorLecturerEmailContext context, String rawPassword) throws MessagingException {
        try {
            sendEmailWithTemplate(to, subject, context, EmailTemplateTypes.MINOR_LECTURE_ADD, true, context.lecturerId(), rawPassword);
