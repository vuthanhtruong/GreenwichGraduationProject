...
public class EmailServiceForStudentDAOImpl implements EmailServiceForStudentDAO {
    ...
    private String generateEmailTemplate(
        ...
        String title = template.getSalutation() != null ? template.getSalutation() : "Access Your Student Account";
        String subtitle = template.getGreeting() != null ? template.getGreeting() : "Welcome to Our University";
        String mainMessage = template.getBody() != null ? template.getBody() : "Your student account has been successfully created. Below are your account details and important information.";
        ...
        html.append("<table class='info-table' role='presentation' width='100%' cellpadding='0' cellspacing='0' style='border:1px solid #e5e7eb;border-radius:10px;overflow:hidden;'>")
                ...
                .append("<td style='padding:12px 14px;font-size:14px;color:#1f2937;width:40%;font-weight:600;border-bottom:1px solid #e5e7eb;font-family:sans-serif;'>Student ID</td>")
                .append("<td style='padding:12px 14px;font-size:14px;color:#374151;border-bottom:1px solid #e5e7eb;font-family:sans-serif;'>").append(safe.apply(context.studentId())).append("</td>")
                .append("</tr>")
                .append("<tr>")
                ...
                .append("</tr>")
                .append("<tr>")
                .append("<td style='padding:12px 14px;font-size:14px;color:#1f2937;font-weight:600;border-bottom:1px solid #e5e7eb;background:#ffffff;font-family:sans-serif;'>Learning Program</td>")
                .append("<td style='padding:12px 14px;font-size:14px;color:#374151;border-bottom:1px solid #e5e7eb;background:#ffffff;font-family:sans-serif;'>").append(learn).append("</td>")
                .append("</tr>")
                .append("<tr style='background:#f8fafc;'>")
