...
@Controller
@RequestMapping("/student-home/evaluations")
public class FeedbackStudentClassesListController {

    private final StudentsService studentsService;
    private final StudentsClassesService studentsClassesService;

    public FeedbackStudentClassesListController(StudentsService studentsService, StudentsClassesService studentsClassesService) {
    ...
    public String listStudentClasses(Model model, HttpSession session,
        ...
        try {
            ...
            return "EvaluationsStudentClassesList";
        } catch (Exception e) {
