...
@Service
public class EmailServiceForLecture {
    ...
    public void sendEmailToNotifyLoginInformation(String to, String subject, Lecturers teacher, String rawPassword) throws MessagingException {
        String htmlMessage = String.format(
                "<html>" +
                        ...
                        "<h2>Hello %s!</h2>" +
                        "<p>Your teacher account has been successfully created. Below are your account details and important information.</p>" +
                        "</div>" +
    ...
    public void sendEmailToNotifyInformationAfterEditing(String to, String subject, Lecturers teacher) throws MessagingException {
        String htmlMessage = String.format(
                "<html>" +
                        ...
                        "<div class='header'>" +
                        "<div class='university-logo'>🎓</div>" +
                        "<h1>Teacher Account Updated</h1>" +
                        "<p>University Notification</p>" +
                        "</div>" +
                        "<div class='content'>" +
                        "<div class='welcome-message'>" +
                        "<h2>Hello %s!</h2>" +
                        "<p>Your teacher account information has been updated. Please review the details below and contact support if any information is incorrect.</p>" +
                        "</div>" +
                        "<div class='alert-box'>" +
