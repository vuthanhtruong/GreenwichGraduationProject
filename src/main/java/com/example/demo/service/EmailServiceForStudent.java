...
@Service
public class EmailServiceForStudent {

    @Autowired
    private JavaMailSender mailSender;

    @Async("emailTaskExecutor")
    public void sendEmailToNotifyLoginInformation(String to, String subject, Students students, String rawPassword) throws MessagingException, MessagingException {
        String htmlMessage = String.format(
                "<html>" +
                        ...
                        "<h2>Hello %s!</h2>" +
                        "<p>Your student account has been successfully created. Below are your account details and important information.</p>" +
                        "</div>" +
                ...
                students.getId(),
                rawPassword,
                students.getFirstName() != null ? students.getFirstName() : "N/A",
                students.getLastName() != null ? students.getLastName() : "N/A",
                students.getEmail(),
                students.getPhoneNumber() != null ? students.getPhoneNumber() : "N/A",
                students.getBirthDate() != null ? students.getBirthDate().toString() : "N/A",
                students.getGender() != null ? students.getGender().toString() : "N/A",
                students.getCampus() != null ? students.getCampus().getCampusName() : "N/A",
                students.getMajor() != null ? students.getMajor().getMajorName() : "N/A",
                students.getMisId() != null ? students.getMisId() : "N/A",
                students.getCreatedDate().toString(),
                students.getCountry() != null ? students.getCountry() : "N/A",
                students.getProvince() != null ? students.getProvince() : "N/A",
                students.getCity() != null ? students.getCity() : "N/A",
                students.getDistrict() != null ? students.getDistrict() : "N/A",
                students.getWard() != null ? students.getWard() : "N/A",
                students.getStreet() != null ? students.getStreet() : "N/A",
                students.getPostalCode() != null ? students.getPostalCode() : "N/A"
        );
    ...
    public void sendEmailToNotifyInformationAfterEditing(String to, String subject, Students students) throws MessagingException {
        String htmlMessage = String.format(
                "<html>" +
                        ...
                        "<div class='header'>" +
                        "<div class='university-logo'>🎓</div>" +
                        "<h1>Student Account Updated</h1>" +
                        "<p>University Notification</p>" +
                        "</div>" +
                        "<div class='content'>" +
                        "<div class='welcome-message'>" +
                        "<h2>Hello %s!</h2>" +
                        "<p>Your student account information has been updated. Please review the details below and contact support if any information is incorrect.</p>" +
                        "</div>" +
                        "<div class='alert-box'>" +
