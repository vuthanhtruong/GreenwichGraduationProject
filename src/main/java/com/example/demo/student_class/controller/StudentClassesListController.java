...
import com.example.demo.student_class.service.StudentsClassesService;
...
public class StudentClassesListController {
    ...
    public String listStudentClasses(Model model, HttpSession session,
        ...
        try {
            ...
            List<Students_Classes> allClasses = studentsClassesService.getStudentsInClassByStudent(student.getId());
