...
public class DeleteSpecializedSubjectController {

    private static final Logger logger = LoggerFactory.getLogger(DeleteSpecializedSubjectController.class);

    private final SpecializedSubjectsService subjectsService;

    @Autowired
    public DeleteSpecializedSubjectController(SpecializedSubjectsService subjectsService) {
        this.subjectsService = subjectsService;
    }

    @DeleteMapping("/delete-specialized-subject")
