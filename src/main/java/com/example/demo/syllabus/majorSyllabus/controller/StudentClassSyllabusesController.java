...
public class StudentClassSyllabusesController {
    ...
    public StudentClassSyllabusesController(ClassesService classesService, SyllabusesService syllabusesService, SpecializationSyllabusesService specializationSyllabusesService) {
