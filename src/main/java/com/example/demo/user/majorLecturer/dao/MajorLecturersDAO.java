...
public interface MajorLecturersDAO {
    ...
    // ==================== DASHBOARD CHO STAFF - MAJOR LECTURERS ====================
    ...
    List<Object[]> top5MostExperiencedLecturersInMyMajor();                  // Top 5 giảng viên lâu năm nhất (createdDate)

    // ==================== ADMIN DASHBOARD - MAJOR LECTURERS STATISTICS ====================
